                        ...
                        <Link style={{ textDecoration: "none" }} to="/dashboard/my-profile"><h5 className=" mt-4 "><FontAwesomeIcon icon={faUserTag} /> My profile</h5></Link>
                        {
                            admin ?
                                ...
                                <>
                                    ...
                                    <Link style={{ textDecoration: "none" }} to="/dashboard/review"><h5 className=" mt-4 text-primary"><FontAwesomeIcon icon={faCommentAlt} /> Make Review</h5></Link>
                                </>
                        }
                    </div>
                </div>
                <div className="col-md-9">
                    <div className="row">
                        <div className="col-md-6 title">
                            <h5 className="text-left font-weight-bold">Review</h5>
                        </div>
                        <div className="col-md-6 title">
